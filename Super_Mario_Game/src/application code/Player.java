...
public class Player {
    ...
    public Player() {
        ...
        this.lvl = 0;
        for (int k = 0; k < 5; k++) {
            imageRight[k] = new Image(("images/player/marioRight" + k + "Lvl" + lvl + ".png"));
            imageLeft[k] = new Image(("images/player/marioLeft" + k + "Lvl" + lvl + ".png"));
        }
        this.x = 100;
    ...
    private void killOrBeKilled(Enemy enemy) {
        if (falling) {
            ...
            if (lvl == 0) {
                imageRight[0] = new Image("images/player/marioDead.png");
                moveLength = 0;
                floor = 550;
                jumping = true;
                gameOver = true;
